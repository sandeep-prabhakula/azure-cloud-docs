...
location="eastus"
resourceGroup="sandeep-azure-functions-rg-$randomIdentifier"
tag="create-function-app-consumption-python"
storage="sandeep$randomIdentifier"
functionApp="sandeep-serverless-python-function-$randomIdentifier"
skuStorage="Standard_LRS"
functionsVersion="4"
pythonVersion="3.13" #Allowed values: 3.7, 3.8, and 3.9
